...
interface RequestShopeeAPI{
    public function execute();
    public function get($resource);
}

class UpdateProductController implements RequestShopeeAPI
{
    ...
    public function execute(){
        return $this->get('api/v2/product/update_price?partner_id='.$this->getPartner_id().'&timestamp='.$this->getTimestamp().'&access_token='.$this->getAccess_token().'&shop_id=436238108'.'&sign='.$this->generateSing());
    }
